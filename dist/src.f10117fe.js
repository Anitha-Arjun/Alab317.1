...
var Vehicle = /** @class */function () {
  function Vehicle(make, model, wheels) {
    //Union of literals by default set to stopped
    this.status = "stopped";
    this.make = make;
    this.model = model;
    this.wheels = wheels;
...
var NCycle = /** @class */function () {
  ...
  NCycle.prototype.print = function (index) {
    ...
    //checks this.make and this.model are both arrays
    if (Array.isArray(this.make) && Array.isArray(this.model)) {
      //checks parameter index exist in this.make and this.model
...
testCycle2.print();
var testCycle3 = new NCycle("Make", "Model Y", 4);
testCycle3.print(4);
